...
def draw_screen():
    ...
    # Zeichne den Balken in zwei Abschnitten mit Loch in der Mitte
    left_bar_rect = (hit_bar_left, size[1] - hit_bar_height, (hit_bar_length - hole_width) // 2, hit_bar_height)
    right_bar_rect = (hit_bar_left + (hit_bar_length + hole_width) // 2, size[1] - hit_bar_height, (hit_bar_length - hole_width) // 2, hit_bar_height)
    pygame.draw.rect(screen, blue, left_bar_rect)
    pygame.draw.rect(screen, blue, right_bar_rect)
